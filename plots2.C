...
/*ts1->Draw("chargedHadronIso>>s1(100,0.1,20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb1->Draw("chargedHadronIso>>b1(100,0.1,20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s1->SetLineColor(kRed); s1->SetFillColor(kRed); s1->SetFillStyle(3001);
s1->DrawNormalized(); b1->DrawNormalized("same");
c->SetLogy(1);
c->SaveAs("PH1_A0_PU50_chargedHadronIso.pdf");
c->SaveAs("PH1_A0_PU50_chargedHadronIso.png");
c->Clear();

ts1->Draw("neutralHadronIso>>s1(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb1->Draw("neutralHadronIso>>b1(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s1->SetLineColor(kRed); s1->SetFillColor(kRed); s1->SetFillStyle(3001);
s1->DrawNormalized(); b1->DrawNormalized("same");
c->SetLogy(1);
c->SaveAs("PH1_A0_PU50_neutralHadronIso.pdf");
c->SaveAs("PH1_A0_PU50_neutralHadronIso.png");
c->Clear();

ts1->Draw("photonIso>>s1(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb1->Draw("photonIso>>b1(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s1->SetLineColor(kRed); s1->SetFillColor(kRed); s1->SetFillStyle(3001);
s1->DrawNormalized(); b1->DrawNormalized("same");
c->SetLogy(1);
c->SaveAs("PH1_A0_PU50_photonIso.pdf");
...
/*ts2->Draw("chargedHadronIso>>s2(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb2->Draw("chargedHadronIso>>b2(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s2->SetLineColor(kRed); s2->SetFillColor(kRed); s2->SetFillStyle(3001);
c->SetLogy(1);
s2->DrawNormalized(); b2->DrawNormalized("same");
c->SaveAs("PH1_A1k_PU140_chargedHadronIso.pdf");
c->SaveAs("PH1_A1k_PU140_chargedHadronIso.png");
c->SetLogy(0);
c->Clear();

ts2->Draw("neutralHadronIso>>s2(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb2->Draw("neutralHadronIso>>b2(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s2->SetLineColor(kRed); s2->SetFillColor(kRed); s2->SetFillStyle(3001);
c->SetLogy(1);
s2->DrawNormalized(); b2->DrawNormalized("same");
c->SaveAs("PH1_A1k_PU140_neutralHadronIso.pdf");
c->SaveAs("PH1_A1k_PU140_neutralHadronIso.png");
c->SetLogy(0);
c->Clear();

ts2->Draw("photonIso>>s2(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb2->Draw("photonIso>>b2(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s2->SetLineColor(kRed); s2->SetFillColor(kRed); s2->SetFillStyle(3001);
c->SetLogy(1);
s2->DrawNormalized(); b2->DrawNormalized("same");
c->SaveAs("PH1_A1k_PU140_photonIso.pdf");
c->SaveAs("PH1_A1k_PU140_photonIso.png");
c->SetLogy(0);
c->Clear();*/
...
/*ts3->Draw("chargedHadronIso>>s3(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb3->Draw("chargedHadronIso>>b3(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s3->SetLineColor(kRed); s3->SetFillColor(kRed); s3->SetFillStyle(3001);
c->SetLogy(1);
s3->DrawNormalized(); b3->DrawNormalized("same");
c->SaveAs("HGC_chargedHadronIso.pdf");
c->SaveAs("HGC_chargedHadronIso.png");
c->SetLogy(0);
c->Clear();

ts3->Draw("neutralHadronIso>>s3(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb3->Draw("neutralHadronIso>>b3(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s3->SetLineColor(kRed); s3->SetFillColor(kRed); s3->SetFillStyle(3001);
c->SetLogy(1);
s3->DrawNormalized(); b3->DrawNormalized("same");
c->SaveAs("HGC_neutralHadronIso.pdf");
c->SaveAs("HGC_neutralHadronIso.png");
c->SetLogy(0);
c->Clear();

ts3->Draw("photonIso>>s3(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100 && matchIndex>-1");
tb3->Draw("photonIso>>b3(100, 0.1, 20)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
s3->SetLineColor(kRed); s3->SetFillColor(kRed); s3->SetFillStyle(3001);
c->SetLogy(1);
s3->DrawNormalized(); b3->DrawNormalized("same");
c->SaveAs("HGC_photonIso.pdf");
c->SaveAs("HGC_photonIso.png");
c->SetLogy(0);
c->Clear();*/
...
<<<<<<< HEAD
	...
	tb1->Draw("abs(etaSC)>>s1numtmp2(9,1.6,2.5)",cut1.str().c_str());
	tb1->Draw("abs(etaSC)>>s1dentmp2(9,1.6,2.5)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
	tb2->Draw("abs(etaSC)>>s2numtmp2(9,1.6,2.5)",cut1.str().c_str());
	tb2->Draw("abs(etaSC)>>s2dentmp2(9,1.6,2.5)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
	tb3->Draw("abs(etaSC)>>s3numtmp2(9,1.6,2.5)",cut1.str().c_str());
	tb3->Draw("abs(etaSC)>>s3dentmp2(9,1.6,2.5)","abs(etaSC) >1.6 && abs(etaSC)<2.5 && pt>30 && pt<100");
	TH1F  *s1numtmp2 = (TH1F*)gDirectory->Get("s1numtmp2");
	TH1F  *s1dentmp2 = (TH1F*)gDirectory->Get("s1dentmp2");
	TH1F  *s2numtmp2 = (TH1F*)gDirectory->Get("s2numtmp2");
...
<<<<<<< HEAD
	...
	float ab2 =s2numtmp2->GetEntries();
	float bb2 =s2dentmp2->GetEntries();
	float ab3 =s3numtmp2->GetEntries();
	float bb3 =s3dentmp2->GetEntries();
	//std::cout << " DEBUG mva - "<< mva <<", "<< a/b   <<std::endl;
        std::cout << "Phase1 PU50 : " << as1/bs1 << " for  mva: " << mva << std::endl;
        std::cout << "Phase1 PU140 : " << as2/bs2 << " for  mva: " << mva << std::endl;
