...
if (iO==1 || iO==-1){
  ...
  //--------- Variables of interest -------------//
	...
	//Mva_->AddVariable("chargedHadronIso", &chargedHadronIso);
	//Mva_->AddVariable("neutralHadronIso", &neutralHadronIso);
	//Mva_->AddVariable("photonIso", &photonIso);
	...
	//ts1->SetBranchAddress("chargedHadronIso", &chargedHadronIso);
	//ts1->SetBranchAddress("neutralHadronIso", &neutralHadronIso);
	//ts1->SetBranchAddress("photonIso", &photonIso);
	...
	//tPho->Branch("chargedHadronIso", &chargedHadronIso, "chargedHadronIso/F");
	//tPho->Branch("neutralHadronIso", &neutralHadronIso, "neutralHadronIso/F");
	//tPho->Branch("photonIso", &photonIso, "photonIso/F");
	...
	//tb1->SetBranchAddress("chargedHadronIso", &chargedHadronIso);
	//tb1->SetBranchAddress("neutralHadronIso", &neutralHadronIso);
	//tb1->SetBranchAddress("photonIso", &photonIso);
	...
	//tBkg->Branch("chargedHadronIso", &chargedHadronIso, "chargedHadronIso/F");
	//tBkg->Branch("neutralHadronIso", &neutralHadronIso, "neutralHadronIso/F");
	//tBkg->Branch("photonIso", &photonIso, "photonIso/F");
